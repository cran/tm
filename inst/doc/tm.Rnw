...
\class{DirSource}, \class{VectorSource}, \class{DataframeSource},
...
consist of several thousand documents, like a
...
versa) handle sparse matrices for text document collections.
<<>>=
